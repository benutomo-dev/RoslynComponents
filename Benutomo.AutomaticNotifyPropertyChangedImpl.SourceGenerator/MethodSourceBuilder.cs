...
namespace Benutomo.AutomaticNotifyPropertyChangedImpl.SourceGenerator
{
    ref struct MethodSourceBuilder
    {
        ...
        void RenderInternalField()
        {
            ...
            PutIndentSpace();
            Append(@"[global::");
            Append(SourceGenerator.AutoGeneratedInternalFieldAttributeFullyQualifiedMetadataName);
            Append(@"(""");
            Append(_sourceBuildInputs.DefaultNotificationPropertyName);
            Append(@""")");
            AppendLine(@"]");
        ...
        void RenderAutoGeneratedInternalAccessorMethodAttribute()
        {
            PutIndentSpace();
            Append(@"[global::");
            Append(SourceGenerator.AutoGeneratedInternalAccessorMethodAttributeFullyQualifiedMetadataName);
            AppendLine(@"]");
        }
