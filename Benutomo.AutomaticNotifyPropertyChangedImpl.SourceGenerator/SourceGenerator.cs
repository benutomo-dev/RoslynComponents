...
";
        ...
        internal const string AutoGeneratedInternalFieldAttributeName = "AutoGeneratedInternalFieldAttribute";
        internal const string AutoGeneratedInternalFieldAttributeFullyQualifiedMetadataName = "Benutomo.Internal.AutoGeneratedInternalFieldAttribute";
        private const string AutoGeneratedInternalFieldAttributeSource = @"
#nullable enable
#pragma warning disable CS0436 // このソース内の型が、別の参照アセンブリのの型と競合している場合の警告を抑止(この警告は同じソースジェネレータを使用している参照プロジェクトのInternalVisibleTo属性に指定されている場合に発生する)
...
";
        ...
        internal const string AutoGeneratedInternalAccessorMethodAttributeName = "AutoGeneratedInternalAccessorMethodAttribute";
        internal const string AutoGeneratedInternalAccessorMethodAttributeFullyQualifiedMetadataName = "Benutomo.Internal.AutoGeneratedInternalAccessorMethodAttribute";
        private const string AutoGeneratedInternalAccessorMethodAttributeSource = @"
#nullable enable
#pragma warning disable CS0436 // このソース内の型が、別の参照アセンブリのの型と競合している場合の警告を抑止(この警告は同じソースジェネレータを使用している参照プロジェクトのInternalVisibleTo属性に指定されている場合に発生する)
...
";
        ...
        void PostInitialization(IncrementalGeneratorPostInitializationContext context)
        {
            ...
            context.CancellationToken.ThrowIfCancellationRequested();
            context.AddSource($"{AutoGeneratedInternalFieldAttributeName}.cs", AutoGeneratedInternalFieldAttributeSource);

            context.CancellationToken.ThrowIfCancellationRequested();
            context.AddSource($"{AutoGeneratedInternalAccessorMethodAttributeName}.cs", AutoGeneratedInternalAccessorMethodAttributeSource);
