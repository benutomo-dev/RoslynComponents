    ...
    internal sealed class Analyzer : DiagnosticAnalyzer
    {
        ...
        private static void AnalyzeClassDeclarationSyntaxNode(SyntaxNodeAnalysisContext context)
        {
            ...
            foreach (var propertyDeclarationSyntax in propertyDeclarationSyntaxes)
            {
                ...
                enableNotificationSupportAttributeSymbol ??= context.Compilation.GetTypeByMetadataName(StaticSourceAttribute.GetFullyQualifiedMetadataName<EnableNotificationSupportAttribute>());
        ...
        private static void AnalyzeInternalFiledReferenceSyntaxNode(SyntaxNodeAnalysisContext context)
        {
            ...
            foreach (var ancestor in identifierNameSyntax.Ancestors())
            {
                ...
                {
                    var autoGeneratedInternalAccessorMethodAttributeSymbol = context.Compilation.GetTypeByMetadataName(StaticSourceAttribute.GetFullyQualifiedMetadataName<AutoGeneratedInternalAccessorMethodAttribute>());
            ...
            var autoGeneratedInternalFieldAttributeSymbol = context.Compilation.GetTypeByMetadataName(StaticSourceAttribute.GetFullyQualifiedMetadataName<AutoGeneratedInternalFieldAttribute>());
        ...
        private static void AnalyzeFieldAccessorSyntaxNode(SyntaxNodeAnalysisContext context, bool isSetter)
        {
            ...
            var enableNotificationSupportAttributeSymbol = context.Compilation.GetTypeByMetadataName(StaticSourceAttribute.GetFullyQualifiedMetadataName<EnableNotificationSupportAttribute>());
